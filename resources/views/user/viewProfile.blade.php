        ...
        <div class="row">
            ...
            <div class="col-md-3 wrap-sidebar">
                ...
                <ul class="user-sidebar">
                    <li><a class="User-button" href="{{route('user.show',Auth::user()->id)}}"><i class="fa fa-eye"></i>   Dashboard</a></li>
                    <li><a class="User-button" href=""><i class="fa fa-edit"></i> update Profile</a></li>
