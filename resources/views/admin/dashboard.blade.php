...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="http://cdn.hireseller.com/css/bootstrap.css" rel='stylesheet' type='text/css' />

    <!-- Custom CSS -->
    <link href="http://cdn.hireseller.com/css/style.css" rel='stylesheet' type='text/css' />
    ...
    <!-- side nav css file -->
    <link href='http://cdn.hireseller.com/css/SidebarNav.min.css' media='all' rel='stylesheet' type='text/css'/>
    <!-- //side nav css file -->
    ...
    <!-- chart -->
    <script src="http://cdn.hireseller.com/js/Chart.js"></script>
    <!-- //chart -->

    <!-- Metis Menu -->
    <script src="http://cdn.hireseller.com/js/metisMenu.min.js"></script>
    <script src="http://cdn.hireseller.com/js/custom.js"></script>
    <link href="http://cdn.hireseller.com/css/custom.css" rel="stylesheet">
    <!--//Metis Menu -->
    <style>
        #chartdiv {
            width: 100%;
    ...
    <link href="http://cdn.hireseller.com/css/owl.carousel.css" rel="stylesheet">
    <script src="http://cdn.hireseller.com/js/owl.carousel.js"></script>
    <script>
        $(document).ready(function() {
        ...
        <aside class="sidebar-left">
            <nav class="navbar navbar-inverse">
                <div class="navbar-header">
                    ...
                    <h1><a class="navbar-brand" href="{{route('admin.index')}}"><span class="fa fa-area-chart"></span> NRB Shop<span class="dashboard_text">welcome::{{Auth::user()->username}}</span></a></h1>
                </div>
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="general.html"><i class="fa fa-angle-right"></i> Show</a></li>
                                <li><a href="general.html"><i class="fa fa-angle-right"></i> Manage Orders</a></li>
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            <div class="profile_img">
                                ...
                                <div class="user-name">
                                    ...
                                    <span class="label label-primary" style="color:#fff; background: #1e88e5">{{Auth::user()->role}}</span>
...
<script src="http://cdn.hireseller.com/js/classie.js"></script>
<script>
...
<!--scrolling js-->
<script src="http://cdn.hireseller.com/js/jquery.nicescroll.js"></script>
<script src="http://cdn.hireseller.com/js/scripts.js"></script>
<!--//scrolling js-->

<!-- side nav js -->
<script src='http://cdn.hireseller.com/js/SidebarNav.min.js' type='text/javascript'></script>
<script>
...
<script src="http://cdn.hireseller.com/js/SimpleChart.js"></script>
