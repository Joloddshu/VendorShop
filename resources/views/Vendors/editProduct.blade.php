                ...
                <div class="col s7 product-field-left">
                    <div class="row">
                        <div class="row">
                            <div class="input-field col s12">
                                <input id="product_name" type="text" value="{{$editProducts->product_name}}" class="validate" name="product_name">
                                <label id="label_Size" for="product_name">Product Name</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s12">
                                <textarea name="product_short_description" id="product_short_description" maxlength="300">
                                    {{$editProducts->product_short_description}}
                                </textarea>
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <textarea name="product_long_description" id="product_long_description" >
                                     {{$editProducts->product_long_description}}
                                </textarea>
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <input id="product_price" type="number" value="{{$editProducts->product_price}}" class="validate" min="0" name="product_price">
                            <label for="product_price">Product Price</label>
                        </div>
                        <div class="input-field col s6">
                            <input id="product_quantity" type="number" value="{{$editProducts->product_quantity}}" class="validate" min="0" name="product_quantity">
            ...
            <div class="product-add-right">
                <div class="col s5">
                    ...
                    <div class="publish_products">
                        <button class="btn waves-effect waves-light"  id="product_submit" type="submit" name="action">Update Product
